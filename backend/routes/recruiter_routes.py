...
# ⭐ FIX: time_ago function DÉPLACÉ ICI (avant utilisation)
def time_ago(dt):
    ...
    for app in applications:
        ...
        result.append({
            ...
            "candidate": {
                ...
                "cv_text": candidate.cv_text[:200] if candidate.cv_text else None,
            }
        })
...
def update_application_status(app_id):
    ...
    allowed_status = ["En attente", "Entretien", "Acceptée", "Refusée"]
...
def send_email():
    try:
        ...
        # ⭐ FIX: SEND EMAIL — signature wassit
